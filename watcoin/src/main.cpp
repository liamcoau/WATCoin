...
uint256 hashGenesisBlock("0x78a8dafbae8344633774ffbee11234e9eb593671089dc853f7dd43587ece6394");
...
{
    int64 nSubsidy = 94 * COIN;

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // WATCoin: 1 days
static const int64 nTargetSpacing = 300; // WATCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal watcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "WATCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe82e711abc3a8376528206efd6c088ef7710acded2899c7703b63fae897d0769");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "14th/Oct/2015: Blue Jays win 5th game against Texas to continue in WS";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1444951090; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1009003;

        if (fTestNet)
        {
            block.nTime    = 1444948630;
            block.nNonce   = 523194;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x6385132be5ee2381e610911c034efdb5b38f00c5e7d01d72e6fbd739f5004c6a"));
