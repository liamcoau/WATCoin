...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // WATCoin: 0.35 days
static const int64 nTargetSpacing = 300; // WATCoin: 15 seconds
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Thursday 15 October 2015";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
