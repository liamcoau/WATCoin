...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("WATCoin Core watcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  watcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded watcoin transaction") + "\n" +
              "  watcoin-tx [options] -create [commands]   " + _("Create hex-encoded watcoin transaction") + "\n" +
              "\n";
