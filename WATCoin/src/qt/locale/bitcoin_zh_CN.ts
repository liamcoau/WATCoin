...
for example: alertnotify=echo %%s | mail -s "WATCoin Alert" admin@foo.com
        ...
        <translation>要使用 watcoind 或者 watcoin-qt 中的 -server 选项，您必须在配置文件中设置一个密码：
%s
建议您使用下列随机密码：
rpcuser=watcoinrpc
rpcpassword=%s
...
例如 alertnotify=echo %%s | mail -s "WATCoin Alert" admin@foo.com
</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>初始化完整性检查失败。WATCoin Core 即将关闭。</translation>
    </message>
    <message>
